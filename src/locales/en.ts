...
export default {
  ...
  "politique-cookies.section.4.3.p1": "We use Resend for sending emails, particularly for our newsletter. Resend may use tracking pixels in emails to collect information about email opens and clicks on links they contain.",
