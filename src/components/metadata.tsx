...
export function generateMetadata({
  ...
  return {
    ...
    description:
      "Ingénieur Full Stack Freelance spécialisé en solutions end-to-end et intégration d'IA.",
    keywords: [
      "développeur web",
      "freelance",
      "Next.js",
    ...
    openGraph: {
      ...
      description:
        "Développeur web freelance spécialisé en solutions end-to-end et intégration d'IA.",
      type: "website",
