                    ...
                    <Select name="sector" onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="education">
                          {t("project-form.sector.education")}
                        </SelectItem>
                        <SelectItem value="ecommerce">
                          {t("project-form.sector.ecommerce")}
                        </SelectItem>
                    ...
                    <Select name="budget" onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="1000-5000">
                          {t("project-form.budget.1000-5000")}
                        </SelectItem>
                        <SelectItem value="5000-10000">
                          {t("project-form.budget.5000-10000")}
                        </SelectItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="1-3months">
                          {t("project-form.timeline.1-3months")}
                        </SelectItem>
                        <SelectItem value="3+months">
                          {t("project-form.timeline.3+months")}
                        </SelectItem>
                        <SelectItem value="flexible">
                          {t("project-form.timeline.flexible")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </FormControl>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="present">
                          {t("project-form.mainObjective.present")}
                        </SelectItem>
                        <SelectItem value="sell">{t("project-form.mainObjective.sell")}</SelectItem>
                        <SelectItem value="automate">
                          {t("project-form.mainObjective.automate")}
                        </SelectItem>
                        <SelectItem value="community">
                          {t("project-form.mainObjective.community")}
                        </SelectItem>
                        <SelectItem value="other">
                          {t("project-form.mainObjective.other")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </FormControl>
